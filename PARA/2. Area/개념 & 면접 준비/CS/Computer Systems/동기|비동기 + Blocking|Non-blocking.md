...
## 동기/비동기 + Blocking/Non-blocking 조합하기
...
- **동기-Blocking**: 간단한 스크립트나 순차적 실행이 중요한 경우
- **비동기-Non-blocking**: 대부분의 웹 애플리케이션, 높은 처리량이 필요한 서버
- **동기-Non-blocking**: 지속적인 상태 모니터링이 필요한 경우
- **비동기-Blocking**: 특수한 멀티스레드 상황, 일부 저수준 I/O 작업
